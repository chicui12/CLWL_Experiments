...
# %%
# ==========================================================
# CLWL single-file experiment script (cell version for VS Code)
# Each `# %%` block can be run independently in VS Code.
# Recommended use:
# 1. run imports/config first
# 2. run one utility/theory cell at a time
# 3. run quick tests before full batch
# ==========================================================
...
# %%
# ==========================================================
# 10. Config cell: edit this most often
# ==========================================================

RUN_MODE = "smoke"   # change to "full" when ready
...
# %%
# ==========================================================
# 11. Quick single-case test cell (recommended before batch)
# ==========================================================

manual_bank = make_e3_manual_bank(c=4)
M_test = manual_bank["E3-A"][0]

cfg_test = ExperimentConfig(
    case_name="debug_E3A_manual_1",
    family="E3-A",
    matrix_name="E3-A_manual_1",
    model_type="linear",
    M=M_test,
    seed=0,
    input_dim=2,
...
out_test = run_single_experiment(cfg_test)
print(pd.DataFrame([out_test["result"]]).T)


# %%
# ==========================================================
# 12. Smoke run cell
# Run this cell only when you want the small batch.
# ==========================================================

results_df_smoke, artifacts_smoke = run_e3_batch(
...
# ==========================================================
# 13. Full run cell
# Run this cell only when you are ready.
# ==========================================================

results_df_full, artifacts_full = run_e3_batch(
...
# %%
# ==========================================================
# 14. Optional inspection cell
# ==========================================================

# Example usage after smoke/full:
# summary = pd.read_csv("./outputs/e3_smoke/results.csv")
# print(summary.head())
